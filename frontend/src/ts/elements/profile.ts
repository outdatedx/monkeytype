...
export async function update(
  ...
  if (!banned) {
    ...
    if (
      ...
      if (git) {
        socialsEl.append(
          `<a href='https://github.com/${git}/' aria-label="${git}" data-balloon-pos="up" target="_blank"><i class="fab fa-fw fa-github"></i></a>`
        );
      }
      ...
      if (twitter) {
        socialsEl.append(
          `<a href='https://twitter.com/${twitter}' aria-label="${twitter}" data-balloon-pos="up" target="_blank"><i class="fab fa-fw fa-twitter"></i></a>`
        );
      }
      ...
      if (website) {
        socialsEl.append(
          `<a href='${website}' aria-label="${websiteName}" data-balloon-pos="up" target="_blank"><i class="fas fa-fw fa-globe"></i></a>`
        );
      }
    }
  }
